 ...
 *
 * @author <a href="mailto:nicolas.deloof@gmail.com">Nicolas De Loof</a>, adapted by Mathieu Delrocq
 */
@Extension
public class FastNodeProvisionerStrategy extends Strategy {
    ...
    public StrategyDecision apply(@Nonnull NodeProvisioner.StrategyState state) {
        ...
        for (Cloud cloud : Jenkins.get().clouds) {
            if (cloud instanceof MacCloud) {
                final StrategyDecision decision = applyForCloud(state, (MacCloud) cloud);
    ...
    private StrategyDecision applyForCloud(@Nonnull NodeProvisioner.StrategyState state, MacCloud cloud) {
